...
export default function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      sourcePage: "/contact",
      sourceCard: "Contact Page Consultation Form",
    };

    // Persist lead directly into MongoDB Atlas
    try {
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-8 space-y-1.5">
            <h1 className="text-2xl sm:text-3xl font-semibold text-neutral-900 tracking-tight font-serif">
              Contact &amp; Kendra Location
            </h1>
            <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed font-normal">
              Visit our consultation chamber opposite Harmu Ground in Ranchi or schedule a private online consultation worldwide.
            </p>
          </div>

          {/* 2-Column Balanced Compact Grid */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">

            {/* Left Column: Contact Cards + Map (Col 5) */}
                ...
                <div className="space-y-3 text-xs">
                  ...
                  <div className="flex items-start gap-2.5 pt-1 border-t border-neutral-100">
                    ...
                    <div>
                      ...
                      <div className="text-neutral-500 text-[11px]">
                        Directions &amp; scheduling assistance
                      </div>
                    </div>
                  </div>
            ...
            {/* Right Column: In-Page Consultation Request Form (Col 7) */}
              ...
              <div className="bg-white border border-[#E6DDCE] p-5 sm:p-6 rounded-lg shadow-2xs">
                ...
                <div className="mb-4 pb-3 border-b border-[#E6DDCE]">
                  ...
                  <p className="text-xs text-neutral-500 mt-0.5 font-normal">
                    Private 1-on-1 consultation with Ach. Dr. Mohit Shah (Ph.D. Vedic Astrology).
                  </p>
                </div>
